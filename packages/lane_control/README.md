...
PROJ-LF-ADAPTIVE: a switch to turn the Adaptive Controller was added in lane_controller_node.py; apart from that code and
package structure were left untouched for the time being.
